...
- (void)viewDidLoad
{
    ...
    self.doppelPictures = @[@"bart", @"flowey", @"bob", @"buggsB", @"louise", @"daffy duck", @"frisk", @"homer", @"sam", @"sans", @"tina"];
    
    self.dopplePicturesReversed = @[@"tina", @"sans", @"daffy duck",@"sam", @"homer", @"frisk", @"louise", @"buggsB", @"bob", @"flowey", @"bart"];
}
