...
+(void) createQuestions:(void(^)(NSMutableArray* questionArray))completion
{
    ...
    ALMQuestions *emotionalOne = [[ALMQuestions alloc]initWithQuestion: @"You're on like for your morning Java, and someone cuts in front of you... you"
    ...
    ALMQuestions *personalityOne = [[ALMQuestions alloc] initWithQuestion: @"You tend to look back at past issues/problems and"
 ...
 //Below is Q 10
    ALMQuestions *esteemThree = [[ALMQuestions alloc] initWithQuestion: @"You see a scared babby pup in the street, what do you do?"
